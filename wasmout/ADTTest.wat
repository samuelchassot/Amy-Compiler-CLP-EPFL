(module 
  ...
  (func $ADTTest_head (param i32) (result i32) (local i32 i32 i32 i32 i32)
    block $match_0
      get_local 0
      set_local 1
      get_local 1
  ...
  (func $ADTTest_tail (param i32) (result i32) (local i32 i32 i32 i32 i32)
    block $match_1
      get_local 0
      set_local 1
      get_local 1
  ...
  (func $ADTTest_foo (result i32) (local i32 i32 i32)
    get_global 0
    get_global 0
    set_local 0
    get_global 0
